...
export default function ScannerPage() {
    ...
    const addEntry = async (roll: string) => {
        ...
        // Success
        setModalMessage({ text: `✓ ${trimmed} recorded`, type: "success" });
    ...
    const exportToCSV = () => {
        ...
        const headers = ["S.No", "Roll Number", "Scan Time"];
            ...
            <div className="z-10 w-full max-w-4xl">
                ...
                <div className="mb-6 flex items-center justify-between rounded-2xl border border-[#e94560]/20 bg-[#e94560]/5 px-6 py-4">
                    <div className="flex items-center gap-4">
                        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#e94560]/20 text-[#e94560]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M22 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>
                        </div>
                        <div>
                            <p className="text-sm font-semibold text-white/90">Total Attendance</p>
                            <p className="text-xs text-white/40">{new Date().toLocaleDateString("en-IN", { weekday: "long", year: "numeric", month: "long", day: "numeric" })}</p>
                        </div>
                    </div>
                        ...
                        <div className="max-h-[500px] overflow-y-auto scrollbar-hide">
                            <table className="w-full text-left">
                                ...
                                <tbody className="divide-y divide-white/[0.04]">
                                    {isLoading ? (
                                        <tr>
                                            <td colSpan={4} className="py-24 text-center text-white/10 animate-pulse">
                                                Syncing with cloud...
                                            </td>
                                        </tr>
                                    ) : entries.length === 0 ? (
                                        <tr>
                                            <td colSpan={4} className="py-24 text-center text-white/10 italic text-sm font-light">
